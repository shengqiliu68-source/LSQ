# Packaging classroom-demo image sources

These images are used only for the owner's non-commercial classroom exercise. Each group was downloaded from the corresponding public Alibaba.com product gallery on July 15, 2026, then center-cropped to 1000 × 780 and converted to WebP.

- `magnetic-*`: [Custom Luxury Magnetic Gift Box](https://www.alibaba.com/product-detail/Custom-Luxury-Magnetic-Gift-box-Thick_1601266962215.html)
